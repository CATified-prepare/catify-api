...
> **Sprint Goal:** Complete Qdrant ingestion pipeline, build RAG search, guardrail service, and exception handling
...
| US-006 | RAG Search Service             | prateekarora7 | 5      |  In Progress |
...
- US-006: Branch work started on PYQ ingestion scaffolding (`POST /api/v1/ingest/pyq`) to seed Qdrant for semantic search.
...
| US-004 | Qdrant Vector Store Setup              | vagrover      | 5      |  Carried to Sprint 2 |
