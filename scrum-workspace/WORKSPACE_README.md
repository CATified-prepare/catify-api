...
> Current focus: Sprint 2 is active. US-005 is still on CSV ingestion, and the US-006 branch has started PYQ ingestion scaffolding to seed Qdrant for semantic search.
